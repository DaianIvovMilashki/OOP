...
отрицателно число, ако първата функция има по-ниска стойност, 0, ако двете функции имат еднаква
стойност и положително число, ако първата функция има по-висока стойност
*/
